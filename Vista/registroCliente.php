...
<body>
  <div class="flex items-center justify-center min-h-screen">
    <div class="bg-white shadow-2xl rounded-3xl p-10 container-custom m-10">
      <form class="space-y-6" method="post" action="../Controlador/registroCliente.php">
        ...
        <div class="container">
          ...
          <?php
            if (isset($_GET['opcion'])) {
              echo '
                <div class="bg-yellow-500 text-white p-2 rounded relative mb-4">
                    <strong>Error:</strong>
                    Campo "Nombre" o "Apellido" incorrecto.<br>
            ...
            if (isset($_GET['success'])) {
              echo '
                <div class="bg-green-500 text-white p-2 rounded relative mb-4">
          ...
          <div class="flex mb-4">
            ...
            <div class="flex-1 pl-2">
              <div class="flex items-center bg-gray-100 border border-gray-300 rounded-lg">
                ...
                <input type="email" id="correo" name="correo" placeholder="Correo Electrónico" class="input bg-transparent focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent w-full p-3 rounded-lg" required>
              </div>
            </div>
          </div>
          ...
          <input type="hidden" name="identificador" id="identificador" value="<?php echo generar_identificador(); ?>">
