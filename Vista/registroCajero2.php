...
<body class="flex items-center justify-center min-h-screen">
    ...
    <form method="post" action="../Controlador/registroCajero3.php">
        ...
        <div class="container bg-white backdrop-blur-lg rounded-lg py-[3rem] px-6 flex flex-col items-center justify-center gap-4 w-[28rem] relative">
