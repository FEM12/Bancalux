  ...
  <div class="flex items-center justify-center min-h-screen">
    <div class="bg-white shadow-2xl rounded-lg p-8 w-full max-w-md">
      <div class="mb-6 text-center">
        <h1 class="text-5xl font-extrabold text-gray-800">¡Bienvenido/a!</h1>
      </div>
      <form class="space-y-6" action="../Controlador/loginGerente.php" method="post">
        <!-- Usuario -->
        <div class="relative">
          ...
          <i class='bx bxs-user absolute left-4 top-3 text-gray-500'></i>
        </div>
        ...
        <div class="relative">
          <input type="password" name="contra" id="contra" placeholder="Contraseña"
            class="input input-bordered w-full pl-12 py-2 border-gray-300 rounded-lg focus:border-blue-500 focus:ring focus:ring-blue-500/50"
            required autocomplete="off">
          <i class='bx bxs-lock-alt absolute left-4 top-3 text-gray-500'></i>
        </div>
