...
<body class="bg-slate-900 bg-fixed bg-cover min-h-screen flex items-center justify-center">
    ...
    <main class="w-full max-w-xs mx-auto bg-white p-8 rounded-lg shadow-lg relative">
    ...
    <h1 class="text-2xl font-bold text-gray-700">Ingresa a nuestro servicio</h1>
    <!-- Agregar el logo debajo de la palabra LOGIN -->
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSO1ClEZtzoSAwXwgbE3iplkg-cZ1zWTnHw0os8S8rlSE9NrDrwc37J0cCOh2Ofzi3j1PI&usqp=CAU" alt="Logo" class="mx-auto mt-4 w-20 h-20"> <!-- Ajusta la ruta y tamaño según tu necesidad -->
</div>
