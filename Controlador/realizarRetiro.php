  ...
  if ($existe > 0) {
    ...
    */
    ...
    if ($existeDui > 0) {
      ...
      $stmt2 = $db -> prepare("SELECT nombre, apellido, correo, idCliente, saldo FROM cuentabanc WHERE numerocuenta = :numerocuenta");
      ...
      if($monto <= $saldo){
        ...
        try {
          ...
          header("Location: ../Vista/indexCajero.php?retiro=retiro");
        ...
        header("Location: ../Vista/realizarRetiro.php?saldo=saldoInsuficiente");
      }

    } else {
      header("Location: ../Vista/realizarRetiro.php?noin=noin");
    }
  } else {
    header("Location: ../Vista/realizarRetiro.php?noex=noex");
  }
}
