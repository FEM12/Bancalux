        ...
        if($existe > 0) {
            ...
            if($monto<=$dato4){
                ...
                try{
                    ...
                    header("Location: ../Vista/index.php?transfe=transfe");
            ...
            else{ header("location: ../Vista/retiro.php?opcion=error"); }

        }
        else{ header("location: ../Vista/transferencias.php?noex=noex"); }
